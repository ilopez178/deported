...
const SHARE_TEXT = 'Try this quiz!\n\nCan you stay in the United States of America? 🚨 Find out if you get deported →'
...
const QUESTION_TIME = 90 // seconds for the entire quiz
